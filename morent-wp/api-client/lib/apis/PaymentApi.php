...
class PaymentApi
{
     ...
     *
     * @param  \OpenAPI\Client\models\PaymentRequest $payment_request payment_request (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\models\PaymentResponse
     */
    public function apiPaymentsPost($payment_request, string $contentType = self::contentTypes['apiPaymentsPost'][0])
    {
        list($response) = $this->apiPaymentsPostWithHttpInfo($payment_request, $contentType);
        return $response;
    }
     ...
     *
     * @param  \OpenAPI\Client\models\PaymentRequest $payment_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiPaymentsPost'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\models\PaymentResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiPaymentsPostWithHttpInfo($payment_request, string $contentType = self::contentTypes['apiPaymentsPost'][0])
    {
        $request = $this->apiPaymentsPostRequest($payment_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\models\PaymentResponse',
                        $request,
                        $response,
                    );
            }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiPaymentsPostAsync($payment_request, string $contentType = self::contentTypes['apiPaymentsPost'][0])
    {
        return $this->apiPaymentsPostAsyncWithHttpInfo($payment_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiPaymentsPostAsyncWithHttpInfo($payment_request, string $contentType = self::contentTypes['apiPaymentsPost'][0])
    {
        $returnType = '\OpenAPI\Client\models\PaymentResponse';
        $request = $this->apiPaymentsPostRequest($payment_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiPaymentsPostRequest($payment_request, string $contentType = self::contentTypes['apiPaymentsPost'][0])
    {
        ...
        if ($payment_request === null || (is_array($payment_request) && count($payment_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payment_request when calling apiPaymentsPost'
            );
        }
