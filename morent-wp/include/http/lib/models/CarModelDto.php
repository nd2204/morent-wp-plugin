 ...
 */
class CarModelDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CarModelDto';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('gear_box', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['gear_box'];
    }
    ...
    {
        if (is_null($gear_box)) {
            throw new \InvalidArgumentException('non-nullable gear_box cannot be null');
        }
        $this->container['gear_box'] = $gear_box;
    ...
    {
        return $this->container['fuel_tank_capacity'];
    }
     ...
     * @return self
     */
    public function setFuelTankCapacity($fuel_tank_capacity)
    {
        if (is_null($fuel_tank_capacity)) {
            throw new \InvalidArgumentException('non-nullable fuel_tank_capacity cannot be null');
        }
        $this->container['fuel_tank_capacity'] = $fuel_tank_capacity;
    ...
    {
        return $this->container['seat_capacity'];
    }
